...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "email", label: "Les émail", emoji: "🎨" },
      { value: "aluminium", label: "Les aluminium", emoji: "🌈" },
      { value: "zircons", label: "Les pièces avec zircons", emoji: "💎" },
      { value: "flash", label: "Les collections flash", emoji: "⚡" },
      { value: "start_pack", label: "Les Start Pack", emoji: "🌱" },
      { value: "pack_indispensable", label: "Les Pack Indispensable", emoji: "💕" },
      { value: "coffrets_mois", label: "Les coffrets du mois", emoji: "🎁" },
      { value: "textures", label: "Les pièces avec texture (martelé, rock, paillette, froissé)", emoji: "🪨" },
      { value: "3d", label: "Les pièces 3D (Shell, Edelweiss, acier découpé)", emoji: "🐚" },
    ],
  },
  {
    id: "saison_mood",
