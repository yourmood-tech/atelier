...
const PROMPTS: Record<string, string> = {
  ...
  "theme-terre-dombre": "TRANSFORM the surroundings of this Mood Collection ring into an ELEGANT TERRE D'OMBRE LUXURY scene while keeping the ring exactly identical (same shape, color, material, finish, gemstones, exact position).\n\nTerre d'ombre decor :\n- Raw terracotta / clay / adobe wall texture in the background — warm earthy material with subtle natural relief (like a sun-baked adobe step, terracotta tiles, or raw unglazed clay surface)\n- Warm directional WARM SIDE LIGHT (sun grazing from the upper-left at ~30-45° angle), casting BOLD CRISP SHADOWS with clean hard edges\n- Dominant color palette : warm terracotta, burnt sienna, raw clay ochre, sand beige, soft cuivre/copper tones — earth pigment family\n- Optional secondary elements (very subtle, blurred deep background) : a hint of natural raw linen drape, a sand-textured ledge, or warm clay architecture out of focus\n- Light quality : late afternoon Mediterranean / Moroccan / Mexican adobe — natural, warm, dry, slightly dusty atmosphere\n- High-end luxury jewelry magazine style, like a Hermès, Loewe or Bottega editorial in a raw earthen setting\n- Surface where the ring sits : warm terracotta clay step or raw unglazed pottery — visible grain/relief but clean (no dust, no parasites)\n- The ring is the absolute hero, with bold shadow cast on the warm clay surface\n\nResult : a luxe terre-d'ombre editorial shot, the ring as the hero, raw earthen ambiance with strong warm side light and crisp bold shadows. Output the transformed image.",
