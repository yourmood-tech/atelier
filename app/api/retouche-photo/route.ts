...
const PROMPTS: Record<string, string> = {
  "fond-blanc": "MOOD CATALOG PACKSHOT — Re-photograph the ring on a pure white catalog background.\n\n🎯🎯🎯 MULTIPLE IMAGES — IDENTIFICATION (CRITICAL) :\n\n💎 IMAGE 1 (FIRST attached) = THE RING TO PHOTOGRAPH ⭐ THIS IS YOUR RING\n   → PRESERVE THIS RING'S EXACT IDENTITY in the output.\n   → Same shape, same colors, same materials, same finish, same gemstones, same engravings, same EXACT pattern, same EXACT number of decoration elements (lines, gemstones, motifs).\n   → ⛔ DO NOT SIMPLIFY the decoration. If IMAGE 1 has 5 rows of pavé diamonds → output 5 rows. If IMAGE 1 has a complex sculptural relief (dent du midi, mountain peaks) → output that EXACT relief.\n   → ⛔ DO NOT REDUCE complexity. Count and preserve every decoration row, every gemstone position, every engraved line.\n   → ⛔ DO NOT REINTERPRET the design. If you see 3D relief → output 3D relief. If you see pavé set → output pavé set.\n   → IGNORE IMAGE 1's current pose/angle/lighting/background — you will re-photograph it.\n\n📐 IMAGE 2 (SECOND attached) = ANGLE REFERENCE ONLY (do NOT use this ring)\n   → COPY ONLY the camera angle/pose/framing from IMAGE 2.\n   → The angle shows the ring lying flat horizontally, viewed from a slight 3/4 angle, the inner polished hole visible on one side as a horizontal oval, the decorated band-surface visible on top in slight perspective.\n   → ⛔ DO NOT use IMAGE 2's ring design/colors/materials.\n   → ⛔ DO NOT use IMAGE 2's lighting or background.\n\nYOUR TASK : Output IMAGE 1's ring (pixel-precise identity preservation) photographed at IMAGE 2's exact angle, on pure white.\n\n⛔ ABSOLUTE FAILURE WARNING : If you output a ring that looks like IMAGE 2's ring instead of IMAGE 1's ring, YOU HAVE FAILED. If you simplify IMAGE 1's decoration (fewer rows, removed elements, flatter pattern), YOU HAVE FAILED.\n\n═══════════════════════════════════════════════\n📷 SHOT SPECIFICATIONS\n═══════════════════════════════════════════════\n\n✂️ PIXEL-PRECISE CUTOUT on PURE WHITE :\n- 100% pure white background (#FFFFFF) — NOT gray, NOT off-white, NOT cream. Exactly RGB 255,255,255.\n- Edges cut at the EXACT pixel boundary of the ring. No fuzzy edge, no halo, no colored fringe, no semi-transparent pixels.\n- Preserve every intricate detail: engravings, gemstones, prongs, small openings, the inner ring hole (background shows through it as pure white).\n- NO cast shadow on the surface. The ring's own 3D self-shadow (modeling the volume) can stay.\n\n📐 ANGLE & FRAMING (match IMAGE 2 reference exactly) :\n- Camera at near eye-level with a very slight downward tilt (~5-15°).\n- Ring lies flat horizontally, slightly tilted to show the inner polished hole as a wide horizontal oval at one end.\n- The decorated outer band-surface is visible on the top of the ring in slight perspective foreshortening.\n- Format: SQUARE 1:1.\n- The ring fills 85-95% of the frame width, centered.\n\n✨ MOOD QUALITY STANDARDS :\n- ✂️ REMOVE all dust, lint, fingerprints, scratches, surface marks, fluff, water spots, residues, oily traces.\n- ✨ Polished metal surfaces are MIRROR-CLEAN with crisp clean reflections.\n- 💎 Gemstones sparkle clean and brilliant.\n- 🎯 Addon-base structure: addon fills the entire central groove between the two polished rails, no overflow, no gaps, flush at the same surface height (no relief/step), uniform width along the entire visible length.\n- 💡 Lighting: even soft studio illumination, subtle gradient reflections, no hotspots.\n- 📏 Ring proportions identical to IMAGE 1 source.\n\n⛔ ABSOLUTE BANS :\n- NO gray/off-white/cream background — only #FFFFFF pure white.\n- NO cast shadow on the surface.\n- NO redesigning, simplifying, or reinterpreting IMAGE 1's decoration.\n- NO swapping rings: the output ring identity MUST be IMAGE 1's, never IMAGE 2's.",
