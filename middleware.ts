...
export default auth((req) => {
  ...
  // /pronostics (jeu-concours public clientes — Mondial 2026)
  if (pathname === "/pronostics" || pathname.startsWith("/pronostics/")) {
    return;
  }
